 ...
 *
 * This abstract class gives guidelines on how the general algorithm is run. It incorporates methods of holding the
 * current search space, generating random neighbours to help the algorithm in choosing good solutions and ties the different
 * parts of the algorithm together.
 */
